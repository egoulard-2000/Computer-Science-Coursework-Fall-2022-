...
%% EXTRA CREDIT Part B
newtonFracData(13).range = [-0.5 0.5 -0.5 0.5];
newtonFracData(13).iterate = 70;
newtonFracData(13).tolerance = 0.00005;
newtonFracData(13).func = @(z)(z - (z^9-1)/(7*z^2));
newtonFracData(13).cmap = @(n)(flipud(bone(n)));

newtonFracData(14).range = [-1 1 -1 1];
newtonFracData(14).iterate = 50;
newtonFracData(14).tolerance = 0.0005;
newtonFracData(14).func = @(z)(z - (z^6-3)/(9*z^6));
newtonFracData(14).cmap = @(n)(flipud(bone(n)));

newtonFracData(15).range = [-2 1 -2 1];
newtonFracData(15).iterate = 30;
newtonFracData(15).tolerance = 0.05;
newtonFracData(15).func = @(z)(z - (z^3-5)/(1*z^5));
newtonFracData(15).cmap = @(n)(flipud(bone(n)));
% End of part B
end