...
#include <memory>
#include "../../../a7-sprite-editor-f22-Stefan-Mada/previewwindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_PreviewWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_PreviewWindow_t qt_meta_stringdata_PreviewWindow = {
    {
        QT_MOC_LITERAL(0, 13),  // "PreviewWindow"
        QT_MOC_LITERAL(14, 12),  // "updateCanvas"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 15),  // "newPreviewImage"
        QT_MOC_LITERAL(44, 16)   // "adjustActualSize"
    },
    "PreviewWindow",
    "updateCanvas",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_PreviewWindow[] = {
...
Q_CONSTINIT const QMetaObject PreviewWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_PreviewWindow.offsetsAndSizes,
...
void PreviewWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateCanvas((*reinterpret_cast< std::add_pointer_t<QImage>>(_a[1]))); break;
        case 1: _t->adjustActualSize(); break;
        default: ;
        }
    }
}
