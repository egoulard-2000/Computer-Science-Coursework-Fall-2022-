...
# Box2D causes strict aliasing and maybe-unitialized warnings when compiled in release mode, so must be suppressed
QMAKE_CXXFLAGS_RELEASE += -O3 -Wno-error=strict-aliasing -Wno-error=maybe-uninitialized
